...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo base_url(); ?>assets/front/assets/img/apple-icon.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/front/assets/img/favicon.ico">
    <!-- Load Require CSS -->
    <link href="<?php echo base_url(); ?>assets/front/assets/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font CSS -->
    <link href="<?php echo base_url(); ?>assets/front/assets/css/boxicon.min.css" rel="stylesheet">
...
<body>
    ...
    <!-- Isotope -->
    <script src="<?php echo base_url(); ?>assets/front/assets/js/isotope.pkgd.js"></script>
    <!-- Page Script -->
    <script>
