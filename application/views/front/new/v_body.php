<body>
    ...
    <section id="infinite" class="text-white tm-font-big tm-parallax">
        ...
        <!-- <div class="row justify-content-center">
            <div class="col-md-9">
                <div class="tm-next tm-intro-next row d-flex justify-content-around">
                    <a href="#whatwedo" class="col-md-3 tm-down-arrow-link">
                        <i class="fas fa-3x fa-map-marked-alt tm-down-arrow"></i>
                    </a>
                    <a href="#whatwedo" class="col-md-3 tm-down-arrow-link">
                        <i class="fas fa-3x fa-map-marked-alt tm-down-arrow"></i>
                    </a>
