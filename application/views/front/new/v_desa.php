                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-5">
                                        <div class="about-img">
                                            <?php foreach ($aq as $row) { ?>
                                                <a target="_blank" href="<?php echo base_url(); ?>gambar/peta_desa/<?php echo $row->md_peta; ?>" title="<?php echo $row->md_peta; ?>">
                                                <img src="<?php echo base_url(); ?>gambar/peta_desa/<?php echo $row->md_peta; ?>" class="img-fluid rounded b-shadow-a"></a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-7">
                                        <div class="about-info">
                                            ...
                                            <?php foreach ($aq as $row) { ?>
                                                <p><span class="title-s">Kecamatan : </span><?php echo Ucwords($row->md_kec) ?></p>
                                                <p><span class="title-s">Desa : </span><?php echo Ucwords($row->md_desa) ?></p>
                                                <?php if ($row->md_luas != 0) { ?> <p><span class="title-s">Luas: </span> <span><?php echo number_format (($row->md_luas),3,',','.'); ?> km<sup>2</sup></span></p><?php } ?>
                                                <?php if ($row->md_pgaris != 0) { ?> <p><span class="title-s">Panjang Garis: </span> <span><?php echo number_format (($row->md_pgaris),3,',','.'); ?> km</span></p><?php } ?>
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width:15%">Panjang Garis (km)</th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($qq as $row) { ?>
                                                    <tr>
                                                        <?php if (($row->d_desa1 == $ab && $row->d_posisi2 == 1) || ($row->d_desa1 == $ab && $row->d_posisi3 == 1) || ($row->d_desa1 == $ab && $row->d_posisi4 == 1) || ($row->d_desa1 == $ab && $row->d_posisi5 == 1) || ($row->d_desa1 == $ab && $row->d_posisi6 == 1) || ($row->d_desa1 == $ab && $row->d_posisi7 == 1) || ($row->d_desa2 == $ab && $row->d_posisi2 == 2) || ($row->d_desa3 == $ab && $row->d_posisi3 == 2) || ($row->d_desa4 == $ab && $row->d_posisi4 == 2) || ($row->d_desa5 == $ab && $row->d_posisi5 == 2) || ($row->d_desa6 == $ab && $row->d_posisi6 == 2) || ($row->d_desa7 == $ab && $row->d_posisi7 == 2)) { ?>
                                                            <td> <?php echo $no++; ?></td>

                                                            <td>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi2 == 1) {
                                                                    echo $row->d_desa2 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi3 == 1) {
                                                                    echo $row->d_desa3 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi4 == 1) {
                                                                    echo $row->d_desa4 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi5 == 1) {
                                                                    echo $row->d_desa5 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi6 == 1) {
                                                                    echo $row->d_desa6 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi7 == 1) {
                                                                    echo $row->d_desa7 . "<br>";
                                                                } ?>
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($qq as $row) { ?>
                                                    <tr>
                                                        <?php if (($row->d_desa1 == $ab && $row->d_posisi2 == 2) || ($row->d_desa1 == $ab && $row->d_posisi3 == 2) || ($row->d_desa1 == $ab && $row->d_posisi4 == 2) || ($row->d_desa1 == $ab && $row->d_posisi5 == 2) || ($row->d_desa1 == $ab && $row->d_posisi6 == 2) || ($row->d_desa1 == $ab && $row->d_posisi7 == 2) || ($row->d_desa2 == $ab && $row->d_posisi2 == 1) || ($row->d_desa3 == $ab && $row->d_posisi3 == 1) || ($row->d_desa4 == $ab && $row->d_posisi4 == 1) || ($row->d_desa5 == $ab && $row->d_posisi5 == 1) || ($row->d_desa6 == $ab && $row->d_posisi6 == 1) || ($row->d_desa7 == $ab && $row->d_posisi7 == 1)) { ?>
                                                            <td> <?php echo $no++; ?></td>

                                                            <td>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi2 == 2) {
                                                                    echo $row->d_desa2 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi3 == 2) {
                                                                    echo $row->d_desa3 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi4 == 2) {
                                                                    echo $row->d_desa4 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi5 == 2) {
                                                                    echo $row->d_desa5 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi6 == 2) {
                                                                    echo $row->d_desa6 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi7 == 2) {
                                                                    echo $row->d_desa7 . "<br>";
                                                                } ?>
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($qq as $row) { ?>
                                                    <tr>
                                                        <?php if (($row->d_desa1 == $ab && $row->d_posisi2 == 3) || ($row->d_desa1 == $ab && $row->d_posisi3 == 3) || ($row->d_desa1 == $ab && $row->d_posisi4 == 3) || ($row->d_desa1 == $ab && $row->d_posisi5 == 3) || ($row->d_desa1 == $ab && $row->d_posisi6 == 3) || ($row->d_desa1 == $ab && $row->d_posisi7 == 3) || ($row->d_desa2 == $ab && $row->d_posisi2 == 4) || ($row->d_desa3 == $ab && $row->d_posisi3 == 4) || ($row->d_desa4 == $ab && $row->d_posisi4 == 4) || ($row->d_desa5 == $ab && $row->d_posisi5 == 4) || ($row->d_desa6 == $ab && $row->d_posisi6 == 4) || ($row->d_desa7 == $ab && $row->d_posisi7 == 4)) { ?>
                                                            <td> <?php echo $no++; ?></td>

                                                            <td>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi2 == 3) {
                                                                    echo $row->d_desa2 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi3 == 3) {
                                                                    echo $row->d_desa3 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi4 == 3) {
                                                                    echo $row->d_desa4 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi5 == 3) {
                                                                    echo $row->d_desa5 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi6 == 3) {
                                                                    echo $row->d_desa6 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi7 == 3) {
                                                                    echo $row->d_desa7 . "<br>";
                                                                } ?>
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($qq as $row) { ?>
                                                    <tr>
                                                        <?php if (($row->d_desa1 == $ab && $row->d_posisi2 == 4) || ($row->d_desa1 == $ab && $row->d_posisi3 == 4) || ($row->d_desa1 == $ab && $row->d_posisi4 == 4) || ($row->d_desa1 == $ab && $row->d_posisi5 == 4) || ($row->d_desa1 == $ab && $row->d_posisi6 == 4) || ($row->d_desa1 == $ab && $row->d_posisi7 == 4) || ($row->d_desa2 == $ab && $row->d_posisi2 == 3) || ($row->d_desa3 == $ab && $row->d_posisi3 == 3) || ($row->d_desa4 == $ab && $row->d_posisi4 == 3) || ($row->d_desa5 == $ab && $row->d_posisi5 == 3) || ($row->d_desa6 == $ab && $row->d_posisi6 == 3) || ($row->d_desa7 == $ab && $row->d_posisi7 == 3)) { ?>
                                                            <td> <?php echo $no++; ?></td>

                                                            <td>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi2 == 4) {
                                                                    echo $row->d_desa2 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi3 == 4) {
                                                                    echo $row->d_desa3 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi4 == 4) {
                                                                    echo $row->d_desa4 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi5 == 4) {
                                                                    echo $row->d_desa5 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi6 == 4) {
                                                                    echo $row->d_desa6 . "<br>";
                                                                } ?>
                                                                <?php if ($row->d_desa1 == $ab && $row->d_posisi7 == 4) {
                                                                    echo $row->d_desa7 . "<br>";
                                                                } ?>
