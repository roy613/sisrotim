                        ...
                        <table id="example1" class="table table-bordered table-striped table-hover table-responsive">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style="width:23%">NO BERITA ACARA/ TENTANG</th>
                            ...
                            <tbody>
                                ...
                                foreach ($bk as $k) { ?>
                                    <tr style="font-size: 10pt;">
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . 'simpan/bk_hapus/' . $k->d_id; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini ?');" class="btn btn-danger" style="font-size: 10pt !important; padding:4px !important">
    ...
    <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h5 class="modal-title" id="exampleModalLabel">INPUT DATA BERITA ACARA PENETAPAN</h5>
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('simpan/bk') ?>" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="tentang">Tentang Berita Acara</label>
                        ...
                        <div class="form-group">
                            <label for="filegambar">Dokumen Berita Acara (pdf)</label>
...
<div class="modal fade" id="tambahpeta" tabindex="-1" aria-labelledby="exampleModalLabel" a data-backdrop="static" data-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url() . 'simpan/bk_peta' ?>" enctype="multipart/form-data">
